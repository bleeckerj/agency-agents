...
```bash
# Step 1 -- generate integration files for generated targets
./scripts/convert.sh
...
- **Codex** — curated workflow skills → `${CODEX_HOME:-~/.codex}/skills/`
...
Codex support ships as a curated set of workflow-oriented skills. It is intentionally not a
1:1 mirror of every agent profile in this repository.
...
Activate in Codex:
```
Use the $agency-ui-implementation skill to implement or review this component.
```
